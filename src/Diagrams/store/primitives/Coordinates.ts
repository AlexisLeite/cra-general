...
import { type AnyMouseEvent, DChangeEvent } from '../elements/Events';
...
export class Coordinates {
  ...
  constructor(
    items?: DChangeEvent | AnyMouseEvent | Event | Coordinates | number[],
    observable = true,
  ) {
    if (C === null) {
    ...
    } else if (items instanceof DChangeEvent) {
